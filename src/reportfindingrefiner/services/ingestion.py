...
from ..config import DEFAULT_DB_PATH, DEFAULT_TABLE_NAME, DEFAULT_REPORTS_FOLDER

def read_reports_from_folder(folder_path: str = DEFAULT_REPORTS_FOLDER) -> List[Report]:
    """
    Read .txt files from a folder, return a list of `Report` objects.
    """
    print(f"Looking for reports in: {folder_path}")
...
def ingest_reports(
    reports_folder: str = DEFAULT_REPORTS_FOLDER,
